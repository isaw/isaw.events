...
from Products.DynamicSelect.config import PROJECTNAME
from Products.DynamicSelect.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install DynamicSelect """
    out = StringIO()
    ...
    try:
        from Products.DynamicSelect.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.DynamicSelect.config import STYLESHEETS
    try:
        ...
        pass
    from Products.DynamicSelect.config import JAVASCRIPTS
    try:
